...
<p align="center">
  <img alt="Opace AI Hub version 1.0.2" src="https://img.shields.io/badge/version-1.0.2-0A7DBB">
...
match. It creates `dist/opace-ai-prompt-library-api-hub-1.0.2.zip`, makes the installed directory
