...
<p align="center">
  <img alt="Opace AI Hub version 1.0.6" src="https://img.shields.io/badge/version-1.0.6-0A7DBB">
...
Version 1.0.6 adds the approved installed-plugin branding and small icon variants. Version 1.0.5
...
match. It creates `dist/opace-ai-prompt-library-api-hub-1.0.6.zip`, makes the installed directory
