...
class AI_Core_Admin {
    ...
    public function print_theme_boot() {
        ...
        if (strpos($id, 'opace-ai-core-integration-hub-prompt-engine') === false) {
            return;
        }
    ...
    public function add_admin_menu() {
        // Main menu page
        add_menu_page(
            __('AI-Core', 'opace-ai-core-integration-hub-prompt-engine'),
            __('AI-Core', 'opace-ai-core-integration-hub-prompt-engine'),
            'manage_options',
        ...
        add_submenu_page(
            'opace-ai-core-integration-hub-prompt-engine',
            __('Dashboard', 'opace-ai-core-integration-hub-prompt-engine'),
            __('Dashboard', 'opace-ai-core-integration-hub-prompt-engine'),
            'manage_options',
            'opace-ai-core-integration-hub-prompt-engine',
            array($this, 'render_dashboard_page')
        ...
        add_submenu_page(
            'opace-ai-core-integration-hub-prompt-engine',
            __('Settings', 'opace-ai-core-integration-hub-prompt-engine'),
            __('Settings', 'opace-ai-core-integration-hub-prompt-engine'),
            'manage_options',
            'ai-core-settings',
        ...
        add_submenu_page(
            'opace-ai-core-integration-hub-prompt-engine',
            __('Prompt Library', 'opace-ai-core-integration-hub-prompt-engine'),
            __('Prompt Library', 'opace-ai-core-integration-hub-prompt-engine'),
            'manage_options',
        ...
        add_submenu_page(
            'opace-ai-core-integration-hub-prompt-engine',
            __('Statistics', 'opace-ai-core-integration-hub-prompt-engine'),
            __('Statistics', 'opace-ai-core-integration-hub-prompt-engine'),
            'manage_options',
            'ai-core-stats',
        ...
        add_submenu_page(
            'opace-ai-core-integration-hub-prompt-engine',
            __('Add-ons', 'opace-ai-core-integration-hub-prompt-engine'),
            __('Add-ons', 'opace-ai-core-integration-hub-prompt-engine'),
            'manage_options',
            'ai-core-addons',
    ...
    public function render_dashboard_page() {
        ...
        <div class="wrap ai-core-dashboard">
            ...
            <div class="ai-core-welcome-panel">
                <h2><?php esc_html_e('Welcome to AI-Core', 'opace-ai-core-integration-hub-prompt-engine'); ?></h2>
                <p><?php esc_html_e('Universal AI Integration Hub for WordPress', 'opace-ai-core-integration-hub-prompt-engine'); ?></p>
                
                <?php if (!$configured): ?>
                    <div class="notice notice-warning inline">
                        <p>
                            <strong><?php esc_html_e('Getting Started:', 'opace-ai-core-integration-hub-prompt-engine'); ?></strong>
                            <?php esc_html_e('Please configure at least one API key in the Settings page to start using AI-Core.', 'opace-ai-core-integration-hub-prompt-engine'); ?>
                        </p>
                        <p>
                            <a href="<?php echo esc_url(admin_url('admin.php?page=ai-core-settings')); ?>" class="button button-primary">
                                <?php esc_html_e('Configure API Keys', 'opace-ai-core-integration-hub-prompt-engine'); ?>
                            </a>
                        </p>
                    </div>
                <?php else: ?>
                    <div class="notice notice-success inline">
                        <p>
                            <strong><?php esc_html_e('Status:', 'opace-ai-core-integration-hub-prompt-engine'); ?></strong>
                            <?php
                            printf(
                                /* translators: %d: number of AI providers that have an API key configured. */
                                esc_html(_n('%d provider configured', '%d providers configured', count($providers), 'opace-ai-core-integration-hub-prompt-engine')),
                                (int) count($providers)
                            );
                            ?>
                        </p>
            ...
            <?php if ($configured): ?>
                <div class="ai-core-stats-overview">
                    <h2><?php esc_html_e('Quick Stats', 'opace-ai-core-integration-hub-prompt-engine'); ?></h2>
                    <div class="ai-core-stats-grid">
                        <div class="stat-box">
                            <span class="stat-label"><?php esc_html_e('Total Requests', 'opace-ai-core-integration-hub-prompt-engine'); ?></span>
                            <span class="stat-value"><?php echo esc_html(number_format_i18n($total_requests)); ?></span>
                        </div>
                        <div class="stat-box">
                            <span class="stat-label"><?php esc_html_e('Total Tokens', 'opace-ai-core-integration-hub-prompt-engine'); ?></span>
                            <span class="stat-value"><?php echo esc_html(number_format_i18n($total_tokens)); ?></span>
                        </div>
                        <div class="stat-box">
                            <span class="stat-label"><?php esc_html_e('Configured Providers', 'opace-ai-core-integration-hub-prompt-engine'); ?></span>
                            <span class="stat-value"><?php echo esc_html(number_format_i18n(count($providers))); ?></span>
                        </div>
                        <div class="stat-box">
                            <span class="stat-label"><?php esc_html_e('Models Used', 'opace-ai-core-integration-hub-prompt-engine'); ?></span>
                            <span class="stat-value"><?php echo esc_html(number_format_i18n($models_used)); ?></span>
                        </div>
                    </div>
                    <?php if (!$has_usage): ?>
                        <p class="ai-core-stats-hint">
                            <?php esc_html_e('No requests recorded yet. Counters start moving as soon as AI-Core or one of its add-ons sends its first request.', 'opace-ai-core-integration-hub-prompt-engine'); ?>
                        </p>
                    <?php endif; ?>
                </div>
                
                <div class="ai-core-providers-status">
                    <h2><?php esc_html_e('Configured Providers', 'opace-ai-core-integration-hub-prompt-engine'); ?></h2>
                    <table class="widefat">
                        <thead>
                            <tr>
                                <th><?php esc_html_e('Provider', 'opace-ai-core-integration-hub-prompt-engine'); ?></th>
                                <th><?php esc_html_e('Status', 'opace-ai-core-integration-hub-prompt-engine'); ?></th>
                                <th><?php esc_html_e('Available Models', 'opace-ai-core-integration-hub-prompt-engine'); ?></th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><span class="dashicons dashicons-yes-alt ai-core-status-ok"></span> <?php esc_html_e('Configured', 'opace-ai-core-integration-hub-prompt-engine'); ?></td>
                                    <td><?php echo count($models); ?> <?php esc_html_e('models', 'opace-ai-core-integration-hub-prompt-engine'); ?></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
            ...
            <div class="ai-core-quick-links">
                <h2><?php esc_html_e('Quick Links', 'opace-ai-core-integration-hub-prompt-engine'); ?></h2>
                <div class="ai-core-links-grid">
                    <a href="<?php echo esc_url(admin_url('admin.php?page=ai-core-settings')); ?>" class="ai-core-link-box">
                        ...
                        <h3><?php esc_html_e('Settings', 'opace-ai-core-integration-hub-prompt-engine'); ?></h3>
                        <p><?php esc_html_e('Configure API keys and preferences', 'opace-ai-core-integration-hub-prompt-engine'); ?></p>
                    </a>
                    <a href="<?php echo esc_url(admin_url('admin.php?page=ai-core-stats')); ?>" class="ai-core-link-box">
                        <span class="dashicons dashicons-chart-bar"></span>
                        <h3><?php esc_html_e('Statistics', 'opace-ai-core-integration-hub-prompt-engine'); ?></h3>
                        <p><?php esc_html_e('View detailed usage statistics', 'opace-ai-core-integration-hub-prompt-engine'); ?></p>
                    </a>
                    <a href="<?php echo esc_url(admin_url('admin.php?page=ai-core-addons')); ?>" class="ai-core-link-box">
                        <span class="dashicons dashicons-admin-plugins"></span>
                        <h3><?php esc_html_e('Add-ons', 'opace-ai-core-integration-hub-prompt-engine'); ?></h3>
                        <p><?php esc_html_e('Discover plugins that extend AI-Core', 'opace-ai-core-integration-hub-prompt-engine'); ?></p>
                    </a>
                </div>
            </div>
        </div>
    ...
    public function render_stats_page() {
        ...
        <div class="wrap">
            ...
            <div class="ai-core-stats-page">
                <h2 class="screen-reader-text"><?php esc_html_e('Usage summary', 'opace-ai-core-integration-hub-prompt-engine'); ?></h2>
                ...
                <?php if ($has_usage): ?>
                    <p>
                        <button type="button" class="button button-primary" id="ai-core-refresh-pricing">
                            <?php esc_html_e('Refresh Model Pricing', 'opace-ai-core-integration-hub-prompt-engine'); ?>
                        </button>
                        <button type="button" class="button" id="ai-core-reset-stats">
                            <?php esc_html_e('Reset Statistics', 'opace-ai-core-integration-hub-prompt-engine'); ?>
                        </button>
                    </p>
                    <div id="ai-core-pricing-status" class="ai-core-inline-status" role="status" aria-live="polite"></div>
                <?php else: ?>
                    <p class="ai-core-stats-hint">
                        <?php esc_html_e('There is nothing to reset yet. Once usage is recorded, a Reset Statistics button appears here.', 'opace-ai-core-integration-hub-prompt-engine'); ?>
                    </p>
                <?php endif; ?>
            </div>
        </div>
