...
class AI_Core_Prompt_Library {
    ...
    public function render_page() {
        ...
        <div class="wrap ai-core-prompt-library">
            <h1><?php esc_html_e('Prompt Library', 'opace-ai-core-integration-hub-prompt-engine'); ?></h1>
            ...
            <div class="ai-core-library-header">
                <div class="ai-core-library-actions">
                    <button type="button" class="button button-primary" id="ai-core-new-prompt">
                        ...
                        <?php esc_html_e('New Prompt', 'opace-ai-core-integration-hub-prompt-engine'); ?>
                    </button>
                    <button type="button" class="button button-primary" id="ai-core-new-group">
                        <span class="dashicons dashicons-category"></span>
                        <?php esc_html_e('New Group', 'opace-ai-core-integration-hub-prompt-engine'); ?>
                    </button>
                    <button type="button" class="button" id="ai-core-import-prompts">
                        <span class="dashicons dashicons-upload"></span>
                        <?php esc_html_e('Import', 'opace-ai-core-integration-hub-prompt-engine'); ?>
                    </button>
                    <button type="button" class="button" id="ai-core-export-prompts">
                        <span class="dashicons dashicons-download"></span>
                        <?php esc_html_e('Export', 'opace-ai-core-integration-hub-prompt-engine'); ?>
                    </button>
                    <button type="button" class="button button-link-delete" id="ai-core-delete-all-prompts" style="color: #b32d2e;">
                        <span class="dashicons dashicons-trash"></span>
                        <?php esc_html_e('Delete All', 'opace-ai-core-integration-hub-prompt-engine'); ?>
                    </button>
                    <a href="<?php echo esc_url( AI_CORE_PLUGIN_URL . 'prompts-template.json' ); ?>"
                       class="button"
                       download
                       title="<?php esc_attr_e('Download JSON template file', 'opace-ai-core-integration-hub-prompt-engine'); ?>">
                        <span class="dashicons dashicons-media-code"></span>
                        <?php esc_html_e('JSON Template', 'opace-ai-core-integration-hub-prompt-engine'); ?>
                    </a>
                    <a href="<?php echo esc_url( AI_CORE_PLUGIN_URL . 'prompts-template.csv' ); ?>"
                       class="button"
                       download
                       title="<?php esc_attr_e('Download CSV template file', 'opace-ai-core-integration-hub-prompt-engine'); ?>">
                        <span class="dashicons dashicons-media-spreadsheet"></span>
                        <?php esc_html_e('CSV Template', 'opace-ai-core-integration-hub-prompt-engine'); ?>
                    </a>
                </div>
                ...
                <div class="ai-core-library-search">
                    <input type="search"
                           ...
                           class="regular-text"
                           aria-label="<?php esc_attr_e('Search prompts', 'opace-ai-core-integration-hub-prompt-engine'); ?>"
                           placeholder="<?php esc_attr_e('Search prompts...', 'opace-ai-core-integration-hub-prompt-engine'); ?>" />
                    <select id="ai-core-filter-group"
                            class="regular-text"
                            aria-label="<?php esc_attr_e('Filter prompts by group', 'opace-ai-core-integration-hub-prompt-engine'); ?>">
                        <option value=""><?php esc_html_e('All Groups', 'opace-ai-core-integration-hub-prompt-engine'); ?></option>
            ...
            <div class="ai-core-library-content">
                <h2 class="screen-reader-text"><?php esc_html_e('Prompt Groups', 'opace-ai-core-integration-hub-prompt-engine'); ?></h2>
                <div id="ai-core-groups-container" class="ai-core-groups-container">
                    <?php if (empty($groups)): ?>
                        <div class="ai-core-empty-state">
                            <span class="dashicons dashicons-category"></span>
                            <h3><?php esc_html_e('No groups yet', 'opace-ai-core-integration-hub-prompt-engine'); ?></h3>
                            <p><?php esc_html_e('Create your first group to organise prompts.', 'opace-ai-core-integration-hub-prompt-engine'); ?></p>
                            <button type="button" class="button button-primary" id="ai-core-new-group-empty">
                                <?php esc_html_e('Create Group', 'opace-ai-core-integration-hub-prompt-engine'); ?>
                            </button>
                        </div>
                    <?php else: ?>
                        <?php
                            ...
                            <div class="ai-core-group-card" data-group-id="<?php echo esc_attr($group['id']); ?>">
                                <div class="group-card-header">
                                    ...
                                    <div class="group-card-actions">
                                        <button type="button" class="button-link edit-group" title="<?php esc_attr_e('Edit Group', 'opace-ai-core-integration-hub-prompt-engine'); ?>">
                                            <span class="dashicons dashicons-edit"></span>
                                        </button>
                                        <button type="button" class="button-link delete-group" title="<?php esc_attr_e('Delete Group', 'opace-ai-core-integration-hub-prompt-engine'); ?>">
                                            <span class="dashicons dashicons-trash"></span>
                                        </button>
                                        <button type="button" class="button-link add-prompt-to-group" title="<?php esc_attr_e('Add Prompt', 'opace-ai-core-integration-hub-prompt-engine'); ?>">
                                            <span class="dashicons dashicons-plus-alt"></span>
                                        </button>
                                    </div>
                                </div>
                                <div class="group-card-body" data-group-id="<?php echo esc_attr($group['id']); ?>">
                                    <?php if (empty($group_prompts)): ?>
                                        <div class="group-empty-state">
                                            ...
                                            <p><?php esc_html_e('No prompts in this group', 'opace-ai-core-integration-hub-prompt-engine'); ?></p>
                                            <p class="description"><?php esc_html_e('Drag prompts here or click + to add', 'opace-ai-core-integration-hub-prompt-engine'); ?></p>
                                        </div>
                                    <?php else: ?>
                        ...
                        ?>
                            <div class="ai-core-group-card ungrouped" data-group-id="0">
                                <div class="group-card-header">
                                    <div class="group-card-title">
                                        <span class="dashicons dashicons-admin-post"></span>
                                        <h3><?php esc_html_e('Ungrouped Prompts', 'opace-ai-core-integration-hub-prompt-engine'); ?></h3>
        ...
        <div id="ai-core-prompt-modal" class="ai-core-modal" style="display: none;">
            <div class="ai-core-modal-content">
                <div class="ai-core-modal-header">
                    <h2 id="ai-core-modal-title"><?php esc_html_e('Edit Prompt', 'opace-ai-core-integration-hub-prompt-engine'); ?></h2>
                ...
                <div class="ai-core-modal-body">
                    ...
                    <table class="form-table">
                        <tr>
                            <th><label for="prompt-title"><?php esc_html_e('Title', 'opace-ai-core-integration-hub-prompt-engine'); ?></label></th>
                            <td><input type="text" id="prompt-title" class="large-text" /></td>
                        </tr>
                        <tr>
                            <th><label for="prompt-group"><?php esc_html_e('Group', 'opace-ai-core-integration-hub-prompt-engine'); ?></label></th>
                            <td>
                                <select id="prompt-group" class="regular-text">
                                    <option value=""><?php esc_html_e('Ungrouped', 'opace-ai-core-integration-hub-prompt-engine'); ?></option>
                                    <?php foreach ($groups as $group): ?>
                                        <option value="<?php echo esc_attr($group['id']); ?>">
                                            <?php echo esc_html($group['name']); ?>
                                        </option>
                        ...
                        <tr>
                            <th><label for="prompt-content"><?php esc_html_e('Prompt', 'opace-ai-core-integration-hub-prompt-engine'); ?></label></th>
                            <td><textarea id="prompt-content" rows="8" class="large-text"></textarea></td>
                        </tr>
                        <tr>
                            <th><label for="prompt-provider"><?php esc_html_e('Provider', 'opace-ai-core-integration-hub-prompt-engine'); ?></label></th>
                            <td>
                                <select id="prompt-provider" class="regular-text">
                                    <option value=""><?php esc_html_e('Default', 'opace-ai-core-integration-hub-prompt-engine'); ?></option>
                        ...
                        <tr>
                            <th><label for="prompt-type"><?php esc_html_e('Type', 'opace-ai-core-integration-hub-prompt-engine'); ?></label></th>
                            <td>
                    ...
                    <div class="ai-core-prompt-test">
                        <h3><?php esc_html_e('Test Prompt', 'opace-ai-core-integration-hub-prompt-engine'); ?></h3>
                ...
                <div class="ai-core-modal-footer">
                    <button type="button" class="button button-primary" id="ai-core-save-prompt">
                        <?php esc_html_e('Save Prompt', 'opace-ai-core-integration-hub-prompt-engine'); ?>
                    </button>
                    <button type="button" class="button" id="ai-core-cancel-prompt">
                        <?php esc_html_e('Cancel', 'opace-ai-core-integration-hub-prompt-engine'); ?>
                    </button>
                </div>
            </div>
        </div>
        ...
        <div id="ai-core-group-modal" class="ai-core-modal" style="display: none;">
            <div class="ai-core-modal-content ai-core-modal-small">
                <div class="ai-core-modal-header">
                    <h2 id="ai-core-group-modal-title"><?php esc_html_e('Edit Group', 'opace-ai-core-integration-hub-prompt-engine'); ?></h2>
                    <button type="button" class="ai-core-modal-close">
                        <span class="dashicons dashicons-no"></span>
                    </button>
                </div>
                <div class="ai-core-modal-body">
                    ...
                    <table class="form-table">
                        <tr>
                            <th><label for="group-name"><?php esc_html_e('Group Name', 'opace-ai-core-integration-hub-prompt-engine'); ?></label></th>
                            <td><input type="text" id="group-name" class="regular-text" /></td>
                        </tr>
                        <tr>
                            <th><label for="group-description"><?php esc_html_e('Description', 'opace-ai-core-integration-hub-prompt-engine'); ?></label></th>
                ...
                <div class="ai-core-modal-footer">
                    <button type="button" class="button button-primary" id="ai-core-save-group">
                        <?php esc_html_e('Save Group', 'opace-ai-core-integration-hub-prompt-engine'); ?>
                    </button>
        ...
        <div id="ai-core-import-modal" class="ai-core-modal" style="display: none;">
            <div class="ai-core-modal-content ai-core-modal-small">
                <div class="ai-core-modal-header">
                    <h2><?php esc_html_e('Import Prompts', 'opace-ai-core-integration-hub-prompt-engine'); ?></h2>
                    <button type="button" class="ai-core-modal-close">
                        <span class="dashicons dashicons-no"></span>
                    </button>
                </div>
                <div class="ai-core-modal-body">
                    <p><?php esc_html_e('Upload a JSON file containing prompts and groups.', 'opace-ai-core-integration-hub-prompt-engine'); ?></p>
                    <input type="file" id="ai-core-import-file" accept=".json" />

                    <div class="ai-core-import-templates">
                        <h4>
                            <span class="dashicons dashicons-download"></span>
                            <?php esc_html_e('Need a template?', 'opace-ai-core-integration-hub-prompt-engine'); ?>
                        </h4>
                        <p>
                            <?php esc_html_e('Download a template file to see the correct format for importing prompts:', 'opace-ai-core-integration-hub-prompt-engine'); ?>
                        </p>
                        <div class="ai-core-import-template-links">
                            <a href="<?php echo esc_url( AI_CORE_PLUGIN_URL . 'prompts-template.json' ); ?>"
                               ...
                               download>
                                <span class="dashicons dashicons-media-code"></span>
                                <?php esc_html_e('Download JSON Template', 'opace-ai-core-integration-hub-prompt-engine'); ?>
                            </a>
                            <a href="<?php echo esc_url( AI_CORE_PLUGIN_URL . 'prompts-template.csv' ); ?>"
                               class="button"
                               download>
                                <span class="dashicons dashicons-media-spreadsheet"></span>
                                <?php esc_html_e('Download CSV Template', 'opace-ai-core-integration-hub-prompt-engine'); ?>
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <div id="ai-core-export-modal" class="ai-core-modal" style="display: none;">
            <div class="ai-core-modal-content ai-core-modal-small">
                <div class="ai-core-modal-header">
                    <h2><?php esc_html_e('Export Prompts', 'opace-ai-core-integration-hub-prompt-engine'); ?></h2>
                    <button type="button" class="ai-core-modal-close">
                        <span class="dashicons dashicons-no"></span>
                    </button>
                </div>
                <div class="ai-core-modal-body">
                    <p><?php esc_html_e('Choose export format and version.', 'opace-ai-core-integration-hub-prompt-engine'); ?></p>
                    <table class="form-table">
                        <tr>
                            <th scope="row">
                                <label for="ai-core-export-format"><?php esc_html_e('Format', 'opace-ai-core-integration-hub-prompt-engine'); ?></label>
                            </th>
                            <td>
                                <select id="ai-core-export-format" class="regular-text">
                                    <option value="json"><?php esc_html_e('JSON', 'opace-ai-core-integration-hub-prompt-engine'); ?></option>
                                    <option value="csv"><?php esc_html_e('CSV', 'opace-ai-core-integration-hub-prompt-engine'); ?></option>
                                </select>
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">
                                <label for="ai-core-export-version"><?php esc_html_e('Version', 'opace-ai-core-integration-hub-prompt-engine'); ?></label>
                            </th>
                            <td>
        ...
        <div class="ai-core-prompt-card" data-prompt-id="<?php echo esc_attr($prompt_id); ?>" data-group-id="<?php echo esc_attr($group_id); ?>">
            <div class="prompt-card-header">
                ...
                <div class="prompt-card-actions">
                    <button type="button" class="button-link edit-prompt" data-prompt-id="<?php echo esc_attr($prompt_id); ?>" title="<?php esc_attr_e('Edit', 'opace-ai-core-integration-hub-prompt-engine'); ?>">
                        <span class="dashicons dashicons-edit"></span>
                    </button>
                    <button type="button" class="button-link delete-prompt" data-prompt-id="<?php echo esc_attr($prompt_id); ?>" title="<?php esc_attr_e('Delete', 'opace-ai-core-integration-hub-prompt-engine'); ?>">
                        <span class="dashicons dashicons-trash"></span>
                    </button>
                </div>
            </div>
            ...
            <div class="prompt-card-footer">
                ...
                <button type="button" class="button button-small run-prompt" data-prompt-id="<?php echo esc_attr($prompt_id); ?>">
                    <span class="dashicons dashicons-controls-play"></span>
                    <?php esc_html_e('Run', 'opace-ai-core-integration-hub-prompt-engine'); ?>
                </button>
            </div>
        </div>
        <?php
    ...
    public function save_prompt($data) {
        ...
        if (!is_array($data)) {
            return new WP_Error('ai_core_invalid_prompt', __('Prompt data must be an array', 'opace-ai-core-integration-hub-prompt-engine'));
        }
        ...
        if (empty($title) || empty($content)) {
            return new WP_Error('ai_core_missing_field', __('Title and content are required', 'opace-ai-core-integration-hub-prompt-engine'));
        }
        ...
        if (false === $result) {
            return new WP_Error(
                'ai_core_save_failed',
                __('Failed to save prompt', 'opace-ai-core-integration-hub-prompt-engine'),
    ...
    public function save_group($data) {
        ...
        if (!is_array($data)) {
            return new WP_Error('ai_core_invalid_group', __('Group data must be an array', 'opace-ai-core-integration-hub-prompt-engine'));
        }
        ...
        if (empty($name)) {
            return new WP_Error('ai_core_missing_field', __('Group name is required', 'opace-ai-core-integration-hub-prompt-engine'));
        }
        ...
        if (false === $result) {
            return new WP_Error(
                'ai_core_save_failed',
                __('Failed to save group', 'opace-ai-core-integration-hub-prompt-engine'),
                array('db_error' => $wpdb->last_error)
            );
        }
